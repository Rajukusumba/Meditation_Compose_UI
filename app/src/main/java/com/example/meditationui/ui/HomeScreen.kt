...
import com.example.meditationui.ui.theme.Purple40
import com.example.meditationui.ui.theme.Purple80
import com.example.meditationui.ui.theme.PurpleGrey40
import com.example.meditationui.ui.theme.PurpleGrey80
...
fun HomeScreen(){
    Box(modifier = Modifier
        ...
        Column() {
            ...
            FeatureSection(
                features = listOf(
                    ...
                    Feature(
                        title = "Calming sounds",
                        com.example.meditationui.R.drawable.ic_play,
                        Purple80,
                        PurpleGrey80,
                        Pink80
                    )
        ...
        BottomMenu(items = listOf(
            BottomMenuContent("Home", com.example.meditationui.R.drawable.ic_home),
            BottomMenuContent("Meditate", com.example.meditationui.R.drawable.ic_bubble),
            BottomMenuContent("Sleep", com.example.meditationui.R.drawable.ic_moon),
            BottomMenuContent("Music",com.example.meditationui.R.drawable.ic_music),
            BottomMenuContent("Profile", com.example.meditationui.R.drawable.ic_profile),
...
fun FeatureSection(features: List<Feature>) {
    Column(modifier = Modifier.fillMaxWidth()) {
        ...
        {
            items(features.size) {
                FetureItem(feature = features[it])
            }
        }
...
@Composable
fun FetureItem(feature: Feature) {
    BoxWithConstraints(
        modifier = Modifier
            .padding(7.5.dp)
            .aspectRatio(1f)
...
@Composable
fun GreetingSection(name:String="Raju"){
Row() {
    Row(
